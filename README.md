...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools@v0.1.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { map, map2, map3 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools@v0.1.0-esm/index.mjs';
```
